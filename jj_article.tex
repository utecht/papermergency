...
\author[
   addressref={uams},                   % id's of addresses, e.g. {aff1,aff2}
   corref={uams},                       % id of corresponding address, if any
...
\address[id=uams]{%                           % unique id
  \orgname{Department of Biomedical Informatics, University of Arkansas for Medical Sciences}, % university, etc
